...
const experienceData = [
  {
    company: "Kuchtoh Technologies",
    position: "Frontend Developer Intern",
    duration: "July 2023 - Oct 2023",
    location: "Remote",
    description:
      "As a Frontend Developer Intern, I contributed to production-level projects by building responsive, accessible user interfaces using Nuxt. I collaborated with senior developers to implement new features, fix bugs, and participated in code reviews and Agile sprint ceremonies, gaining hands-on experience in a professional development workflow.",
    responsibilities: [],
    logo: "/assets/healthlancing-logo.webp",
  }
